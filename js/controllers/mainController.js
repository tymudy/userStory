                    ...
                    function ($scope, $rootScope, $translate, $http, ModalService) {
                        ...
                        $scope.gridOptions = {
                            ...
                            columnDefs: [
                                ...
                                { field: "edit", displayName: $translate.instant('edit'), width: 80, cellTemplate:'<div class="grid-action-cell">'+'<button type="button" id="btn-resize" class="btn btn-info btn-xs" data-ng-click=edit()>Edit</button></div>'},
                                { field: "delete", displayName: $translate.instant('delete'), cellTemplate:'<div class="grid-action-cell">'+'<button type="button" id="btn-resize" class="btn btn-danger btn-xs" data-ng-click=delete()>Delete</button></div>'}
                            ]
                        }
